      ...
      <div className="max-w-9xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <nav className="hidden md:flex space-x-8">
            ...
            <Link to="/privacy-policy" className="text-gray-700 hover:text-primary-600 transition-colors">Privacy Policy</Link>
  <Link to="/terms-of-service" className="text-gray-700 hover:text-primary-600 transition-colors">Terms of Service</Link>
          </nav>
        </div>
      </div>
    </motion.header>
